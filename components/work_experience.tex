...
\begin{itemize}
    ...
    \item Optimized \highlight{OpenAI large language models} using techniques such as \highlight{fine-tuning, prompt engineering, and Retrieval-Augmented Generation}, achieving a \tealcolor{98\%} accuracy in content relevance and quality
